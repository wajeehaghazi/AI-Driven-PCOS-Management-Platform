...
export function SymptomAssessment() {
  ...
  // Auto-scroll whenever messages or typing indicator updates
  useEffect(() => {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-[90vw] max-w-7xl mx-auto">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-blue-100">
          ...
          {/* Chat container */}
          <div
            className="h-[550px] overflow-y-auto p-6 bg-gradient-to-b from-blue-50 to-white"
            aria-live="polite"
          >
            <div className="space-y-6">
              {messages.map((message, index) => (
                <div key={index} className={`flex ${message.sender === 'user' ? 'justify-end' : 'justify-start'} animate-fadeIn`}>
                      ...
                      {message.content.split('\n').map((line, i) => {
                        ...
                        return (
                          <React.Fragment key={i}>
                            {isNumberedList ? (
                              <div className="ml-4 mb-2">{line}</div>
                            ) : (
                              <>
                                {line}
                  ...
                  {message.sender === 'user' && (
                    <div className="bg-gray-200 rounded-full p-2 ml-3 h-fit">
          ...
          <div className="border-t border-gray-200 p-6 bg-white">
            <div className="flex items-end">
              <textarea
                className="flex-grow border-2 border-gray-200 rounded-xl px-5 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none bg-gray-50"
              ...
              />
              <button
                className="ml-4 p-4 bg-gradient-to-r from-blue-600 to-teal-600 text-white rounded-xl hover:from-blue-700 hover:to-teal-700 transition-all duration-300 flex-shrink-0 shadow-lg shadow-blue-600/20"
                onClick={handleSend}
            ...
            <div className="mt-3 text-xs text-gray-500 flex items-center">
              ...
              <span>
                Your data is secure and only used to provide personalized assessments
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <h4 className="font-medium text-gray-900 mb-2 text-lg">Conversational AI</h4>
            <p className="text-gray-700 text-sm">
              Natural language processing understands your symptoms and provides personalized insights.
            </p>
          </div>
          <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <h4 className="font-medium text-gray-900 mb-2 text-lg">Adaptive Questioning</h4>
            <p className="text-gray-700 text-sm">
              Questions adapt based on your responses to gather the most relevant information for assessment.
            </p>
          </div>
          <div className="bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
            ...
            <h4 className="font-medium text-gray-900 mb-2 text-lg">Medically Informed</h4>
            <p className="text-gray-700 text-sm">
              Our system is trained on medical literature and validated by healthcare professionals.
            </p>
          </div>
        </div>
      </div>
...
function ShieldIcon(props: { size: number; className?: string }) {
  return (
...
function BrainIcon(props: { size: number; className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.size} height={props.size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={props.className}>
